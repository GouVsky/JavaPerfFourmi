...
public final class MyGraphics2D extends Graphics2D implements ConstrainableGraphics, Cloneable, DestSurfaceProvider {
    ...
    public MyGraphics2D(SurfaceData var1, Color var2, Color var3, Font var4)
    {
        graphics2D = new SunGraphics2D(var1, var2, var3, var4);
        ...
        try {
            ...
            if (this.fontInfo != null) {
                if (this.validFontInfo) {
                    FontInfo fontInfo = var1.getFontInfo();
                    fontInfo = (FontInfo)this.fontInfo.clone();
                } else {
                    fontInfo = null;
                }
            }
            ...
            if (this.glyphVectorFontInfo != null) {
                FontInfo glyphVectorFontInfo = var1.getFontInfo();
                glyphVectorFontInfo = (FontInfo)this.glyphVectorFontInfo.clone();
                glyphVectorFRC = this.glyphVectorFRC;
            }
    ...
    public void validatePipe() {
        if (!this.surfaceData.isValid()) {
            ...
            this.surfaceData.validatePipe(graphics2D);
        }
    }
    ...
    public FontInfo checkFontInfo(FontInfo var1, Font var2, FontRenderContext var3) {
        ...
        if (var3 == null) {
            ...
            var9 = ((Value)var3.getAntiAliasingHint()).getIndex();
        }
        ...
        if (var9 == 0) {
            ...
            if (!this.surfaceData.canRenderLCDText(graphics2D)) {
                var9 = 2;
            } else {
    ...
    public void setRenderingHint(Key var1, Object var2) {
        if (!var1.isCompatibleValue(var2)) {
            ...
            if (var1 instanceof sun.awt.SunHints.Key) {
                boolean var4 = false;
                boolean var5 = true;
                sun.awt.SunHints.Key var6 = (sun.awt.SunHints.Key)var1;
                int var7;
                if (var6 == SunHints.KEY_TEXT_ANTIALIAS_LCD_CONTRAST) {
                    var7 = (Integer)var2;
                } else {
                    var7 = ((Value)var2).getIndex();
                }
    ...
    public Object getRenderingHint(Key var1) {
        ...
        } else if (!(var1 instanceof sun.awt.SunHints.Key)) {
            return null;
        } else {
            int var2 = ((sun.awt.SunHints.Key)var1).getIndex();
            switch(var2) {
                case 0:
                    return Value.get(0, this.renderHint);
                case 1:
                    return Value.get(1, this.antialiasHint);
                case 2:
                    return Value.get(2, this.textAntialiasHint);
                case 3:
                    return Value.get(3, this.fractionalMetricsHint);
                case 5:
                ...
                case 8:
                    return Value.get(8, this.strokeHint);
                case 9:
                    return Value.get(9, this.resolutionVariantHint);
                case 100:
        ...
        while(true) {
            while(var3.hasNext()) {
                ...
                if (var4 != SunHints.KEY_RENDERING && var4 != SunHints.KEY_ANTIALIASING && var4 != SunHints.KEY_TEXT_ANTIALIASING && var4 != SunHints.KEY_FRACTIONALMETRICS && var4 != SunHints.KEY_TEXT_ANTIALIAS_LCD_CONTRAST && var4 != SunHints.KEY_STROKE_CONTROL && var4 != SunHints.KEY_INTERPOLATION) {
                    ...
                    this.setRenderingHint((Key)var4, var1.get(var4));
                }
            }
    ...
    RenderingHints makeHints(Map var1) {
        ...
        var2.put(SunHints.KEY_RENDERING, Value.get(0, this.renderHint));
        var2.put(SunHints.KEY_ANTIALIASING, Value.get(1, this.antialiasHint));
        var2.put(SunHints.KEY_TEXT_ANTIALIASING, Value.get(2, this.textAntialiasHint));
        var2.put(SunHints.KEY_FRACTIONALMETRICS, Value.get(3, this.fractionalMetricsHint));
        ...
        var2.put(SunHints.KEY_STROKE_CONTROL, Value.get(8, this.strokeHint));
        return var2;
    }
    ...
    public void setColor(int value) {
        this.pixel = this.surfaceData.pixelFor(value);
    ...
    public boolean hitClip(int var1, int var2, int var3, int var4) {
        if (var3 > 0 && var4 > 0) {
            if (this.transformState > 1) {
                ...
                this.transform.transform(var5, 0, var5, 0, 4);
    ...
    protected void validateCompClip() {
        ...
        if (this.usrClip == null) {
            ...
            int[] var3 = new int[4];
            ShapeSpanIterator var4 = LoopPipe.getFillSSI(graphics2D);
    ...
    protected static Shape transformShape(int var0, int var1, Shape var2) {
        if (var2 == null) {
            ...
            return new Double(var4.getX() + (double)var0, var4.getY() + (double)var1, var4.getWidth(), var4.getHeight());
    ...
    protected static Shape transformShape(AffineTransform var0, Shape var1) {
        if (var1 == null) {
            ...
            return new Double(var3[0], var3[1], var3[2] - var3[0], var3[3] - var3[1]);
        } else {
    ...
    private void doCopyArea(int var1, int var2, int var3, int var4, int var5, int var6) {
        if (var3 > 0 && var4 > 0) {
            ...
            if (!var7.copyArea(graphics2D, var1, var2, var3, var4, var5, var6)) {
                if (this.transformState > 3) {
                    ...
                    this.transform.transform(var14, 0, var14, 0, 3);
    ...
    public void drawLine(int var1, int var2, int var3, int var4) {
        try {
            this.drawpipe.drawLine(graphics2D, var1, var2, var3, var4);
    ...
    public void drawRoundRect(int var1, int var2, int var3, int var4, int var5, int var6) {
        try {
            this.drawpipe.drawRoundRect(graphics2D, var1, var2, var3, var4, var5, var6);
        } catch (InvalidPipeException var14) {
            try {
                this.revalidateAll();
                this.drawpipe.drawRoundRect(graphics2D, var1, var2, var3, var4, var5, var6);
    ...
    public void fillRoundRect(int var1, int var2, int var3, int var4, int var5, int var6) {
        try {
            this.fillpipe.fillRoundRect(graphics2D, var1, var2, var3, var4, var5, var6);
        } catch (InvalidPipeException var14) {
            try {
                this.revalidateAll();
                this.fillpipe.fillRoundRect(graphics2D, var1, var2, var3, var4, var5, var6);
    ...
    public void drawOval(int var1, int var2, int var3, int var4) {
        try {
            this.drawpipe.drawOval(graphics2D, var1, var2, var3, var4);
        } catch (InvalidPipeException var12) {
            try {
                this.revalidateAll();
                this.drawpipe.drawOval(graphics2D, var1, var2, var3, var4);
    ...
    public void fillOval(int var1, int var2, int var3, int var4) {
        try {
            this.fillpipe.fillOval(graphics2D, var1, var2, var3, var4);
        } catch (InvalidPipeException var12) {
            try {
                this.revalidateAll();
                this.fillpipe.fillOval(graphics2D, var1, var2, var3, var4);
    ...
    public void drawArc(int var1, int var2, int var3, int var4, int var5, int var6) {
        try {
            this.drawpipe.drawArc(graphics2D, var1, var2, var3, var4, var5, var6);
        } catch (InvalidPipeException var14) {
            try {
                this.revalidateAll();
                this.drawpipe.drawArc(graphics2D, var1, var2, var3, var4, var5, var6);
    ...
    public void fillArc(int var1, int var2, int var3, int var4, int var5, int var6) {
        try {
            this.fillpipe.fillArc(graphics2D, var1, var2, var3, var4, var5, var6);
        } catch (InvalidPipeException var14) {
            try {
                this.revalidateAll();
                this.fillpipe.fillArc(graphics2D, var1, var2, var3, var4, var5, var6);
    ...
    public void drawPolyline(int[] var1, int[] var2, int var3) {
        try {
            this.drawpipe.drawPolyline(graphics2D, var1, var2, var3);
        } catch (InvalidPipeException var11) {
            try {
                this.revalidateAll();
                this.drawpipe.drawPolyline(graphics2D, var1, var2, var3);
    ...
    public void drawPolygon(int[] var1, int[] var2, int var3) {
        try {
            this.drawpipe.drawPolygon(graphics2D, var1, var2, var3);
        } catch (InvalidPipeException var11) {
            try {
                this.revalidateAll();
                this.drawpipe.drawPolygon(graphics2D, var1, var2, var3);
    ...
    public void fillPolygon(int[] var1, int[] var2, int var3) {
        try {
            this.fillpipe.fillPolygon(graphics2D, var1, var2, var3);
        } catch (InvalidPipeException var11) {
            try {
                this.revalidateAll();
                this.fillpipe.fillPolygon(graphics2D, var1, var2, var3);
    ...
    public void drawRect(int var1, int var2, int var3, int var4) {
        try {
            this.drawpipe.drawRect(graphics2D, var1, var2, var3, var4);
        } catch (InvalidPipeException var12) {
            try {
                this.revalidateAll();
                this.drawpipe.drawRect(graphics2D, var1, var2, var3, var4);
    ...
    public void fillRect(int var1, int var2, int var3, int var4) {
        try {
            this.fillpipe.fillRect(graphics2D, var1, var2, var3, var4);
        } catch (InvalidPipeException var12) {
            try {
                this.revalidateAll();
                this.fillpipe.fillRect(graphics2D, var1, var2, var3, var4);
    ...
    public void draw(Shape var1) {
        try {
            this.shapepipe.draw(graphics2D, var1);
    ...
    public void fill(Shape var1) {
        try {
            this.shapepipe.fill(graphics2D, var1);
        } catch (InvalidPipeException var9) {
            try {
                this.revalidateAll();
                this.shapepipe.fill(graphics2D, var1);
    ...
    public void drawString(String var1, int var2, int var3) {
        if (var1 == null) {
            ...
            try {
                this.textpipe.drawString(graphics2D, var1, (double)var2, (double)var3);
            } catch (InvalidPipeException var11) {
                try {
                    this.revalidateAll();
                    this.textpipe.drawString(graphics2D, var1, (double)var2, (double)var3);
    ...
    public void drawGlyphVector(GlyphVector var1, float var2, float var3) {
        if (var1 == null) {
            ...
            try {
                this.textpipe.drawGlyphVector(graphics2D, var1, var2, var3);
            } catch (InvalidPipeException var11) {
                try {
                    this.revalidateAll();
                    this.textpipe.drawGlyphVector(graphics2D, var1, var2, var3);
    ...
    public void drawChars(char[] var1, int var2, int var3, int var4, int var5) {
        if (var1 == null) {
            ...
            if (this.font.hasLayoutAttributes()) {
                ...
                try {
                    this.textpipe.drawChars(graphics2D, var1, var2, var3, var4, var5);
                } catch (InvalidPipeException var13) {
                    try {
                        this.revalidateAll();
                        this.textpipe.drawChars(graphics2D, var1, var2, var3, var4, var5);
    ...
    public void drawBytes(byte[] var1, int var2, int var3, int var4, int var5) {
        if (var1 == null) {
            ...
            if (this.font.hasLayoutAttributes()) {
                ...
                try {
                    this.textpipe.drawChars(graphics2D, var6, 0, var3, var4, var5);
                } catch (InvalidPipeException var14) {
                    try {
                        this.revalidateAll();
                        this.textpipe.drawChars(graphics2D, var6, 0, var3, var4, var5);
    ...
    private boolean drawHiDPIImage(Image var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Color var10, ImageObserver var11) {
        ...
        boolean var28;
        try {
            boolean var27 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11);
            return var27;
        } catch (InvalidPipeException var25) {
            try {
                this.revalidateAll();
                var28 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11);
    ...
    public boolean copyImage(Image var1, int var2, int var3, int var4, int var5, int var6, int var7, Color var8, ImageObserver var9) {
        boolean var11;
        try {
            boolean var10 = this.imagepipe.copyImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9);
            return var10;
        } catch (InvalidPipeException var18) {
            try {
                this.revalidateAll();
                var11 = this.imagepipe.copyImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9);
    ...
    public boolean drawImage(Image var1, int var2, int var3, int var4, int var5, Color var6, ImageObserver var7) {
        if (var1 == null) {
            ...
            if (this.isHiDPIImage(var1)) {
                ...
                boolean var11;
                try {
                    boolean var10 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7);
                    return var10;
                } catch (InvalidPipeException var18) {
                    try {
                        this.revalidateAll();
                        var11 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7);
                    } catch (InvalidPipeException var17) {
                        boolean var12 = false;
                        return var12;
                    }
    ...
    public boolean drawImage(Image var1, int var2, int var3, Color var4, ImageObserver var5) {
        if (var1 == null) {
            ...
            boolean var7;
            try {
                boolean var6 = this.imagepipe.copyImage(graphics2D, var1, var2, var3, var4, var5);
                return var6;
            } catch (InvalidPipeException var14) {
                try {
                    this.revalidateAll();
                    var7 = this.imagepipe.copyImage(graphics2D, var1, var2, var3, var4, var5);
                } catch (InvalidPipeException var13) {
                    boolean var8 = false;
                    return var8;
                }
    ...
    public boolean drawImage(Image var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Color var10, ImageObserver var11) {
        if (var1 == null) {
            ...
            if (this.isHiDPIImage(var1)) {
                ...
                boolean var14;
                try {
                    boolean var12 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11);
                    return var12;
                } catch (InvalidPipeException var23) {
                    try {
                        this.revalidateAll();
                        boolean var13 = this.imagepipe.scaleImage(graphics2D, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11);
                        return var13;
    ...
    public boolean drawImage(Image var1, AffineTransform var2, ImageObserver var3) {
        if (var1 == null) {
            ...
            if (this.isHiDPIImage(var1)) {
                ...
                boolean var6;
                try {
                    boolean var4 = this.imagepipe.transformImage(graphics2D, var1, var2, var3);
                    return var4;
                } catch (InvalidPipeException var13) {
                    try {
                        this.revalidateAll();
                        boolean var5 = this.imagepipe.transformImage(graphics2D, var1, var2, var3);
                        return var5;
                    } catch (InvalidPipeException var12) {
                        var6 = false;
                    }
    ...
    public void drawImage(BufferedImage var1, BufferedImageOp var2, int var3, int var4) {
        if (var1 != null) {
            try {
                this.imagepipe.transformImage(graphics2D, var1, var2, var3, var4);
            } catch (InvalidPipeException var12) {
                try {
                    this.revalidateAll();
                    this.imagepipe.transformImage(graphics2D, var1, var2, var3, var4);
    ...
    public FontRenderContext getFontRenderContext() {
        if (this.cachedFRC == null) {
            ...
            this.cachedFRC = new FontRenderContext(var2, Value.get(2, var1), Value.get(3, this.fractionalMetricsHint));
        }
